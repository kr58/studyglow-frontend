    ...
    >
      ...
      <div className="main-dash">
        ...
        <div className="main-user-dash">
          <Stack sx={{ width: "90%", overflow: 'scroll' }}>
                  ...
                  <Stack sx={{ width: "100%" }}>
                    <div className="orderdiv1">
                      ...
                      <div className="detail-container">
                        <Stack direction={{md:"row", xs: "column"}} justifyContent="left" gap={5}>
                ...
                <div className="orderitem-2" style={{ textAlign: "start", marginTop: '4%' }}>
                  <Stack sx={{ width: "100%"}} >
                    <div className="orderdiv2">
                      {/* <span className="detail-head">Order #54606 details</span> */}
                      <Stack direction="row"  className="payment-details" justifyContent="space-between">
                        <div>
                          Item
                        </div>
                      ...
                      <Stack direction="row"  className="payment-details" justifyContent="space-between">
                        ...
                        <Stack direction="row" justifyContent='end'>
                          <div>
                            <Stack direction="row" justifyContent="space-between" className="orderTotal">
                              <div>Items Subtotal:</div>
                              <div>₹4,998.00</div>
                            </Stack>
                            <Stack direction="row" className="orderTotal">
                              <div>Order Total:</div>
                              <div>₹4,998.00</div>
                            </Stack>
                          </div>
